...
* Download the [Starup_Analytics_Dashboard.json](https://github.com/IBM/analyze-insights-on-startup-using-watson-studio/blob/master/code/Startup.json) config file and open it in any editor.
